...
If we want to avoid losing additional data we can use ggplot to create a plot and just remove the NA values to retain all the available values in the dataset.
